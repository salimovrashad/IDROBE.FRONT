...
import photo from '../images/image 31.png'

const MaleSectionTwo = () => {
    return (
        <div className="maletwo container-fluid col-xxl-12 px-4 py-5">
            <div className="row flex-lg-row align-items-center g-5 py-4 pb-1">
                ...
                <div className="maleimage col-10 col-sm-8 col-lg-5">
                    <img src={photo} className="d-block mx-lg-auto" alt="Bootstrap Themes" loading="lazy" />
                </div>
            </div>
        </div>
    )
